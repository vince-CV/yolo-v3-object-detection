...
classes=["aryllatag_paper15","aryllatag_woven15"]
...
def convert_annotation(image_id):
    in_file = open('VOCdevkit/VOC2019/Annotations/%s.xml' %image_id)
    out_file = open('VOCdevkit/VOC2019/labels/%s.txt' %image_id, 'w')
...
VOC_test_file.close()
if not os.path.exists('VOCdevkit/VOC2019/labels'):
    os.makedirs('VOCdevkit/VOC2019/labels')
